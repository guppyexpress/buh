...
var particles = [];
var num_particles = 1;//MMMMMMMMMMMMMMMMMMMMMMMMMMMMMMMMMMMMMMMMMMMMMMMMMMMM MICROWAVE TIME
...
var Particle = function () {
    ...
    this.vx = 50 * Math.random() - 50;//x axis
    this.vy = 60 * Math.random() - 60;//y axis
